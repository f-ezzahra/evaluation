        ...
        <div class="col-md-12 form-wrapper">
          ...
          <form id="create-post-form" @submit.prevent="createCustomer">
               <div class="form-group col-md-12">
                ...
                <input type="text" id="first_name" v-model="first_name" name="title" class="form-control" placeholder="name company">
               </div>
            ...
            <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                  ...
                  <input type="text" id="description" v-model="description" name="description" class="form-control" placeholder="status">
              </div>
